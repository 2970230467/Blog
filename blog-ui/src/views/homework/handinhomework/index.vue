...
<!--批阅作业  -->
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="StuhomeworkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开始时间" align="center" prop="shomework.startTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.shomework.startTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="截止时间" align="center" prop="shomework.endTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.shomework.endTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
